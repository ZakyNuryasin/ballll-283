...
double min_pwm_limit = -7000;
double max_pwm_limit = 7000;
...
//	last_tra_x = pid_error_x;
	pid_current_x = pid_proportional_x;// + pid_integral_x - pid_derivative_x;	//hitung total pid
...
//	last_tra_y = pid_error_y;
	pid_current_y = pid_proportional_y;// + pid_integral_y - pid_derivative_y;
...
//	last_tra_w = pid_error_w;
	pid_current_w = pid_proportional_w;// + pid_integral_w - pid_derivative_w;
